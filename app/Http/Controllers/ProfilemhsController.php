...
class ProfilemhsController extends Controller
{
    public function index()
    {
        ...
        return view('profilemhs.index', ['breadcrumb' => $breadcrumb, 'page' => $page, 'level' => $level, 'user' => $user, 'activeMenu' => $activeMenu]);
    }
    ...
    public function edit_ajax(string $id)
    {
        ...
        return view('profilemhs.edit_ajax', ['user' => $user, 'level' => $level]);
    }
    ...
    public function edit_foto(string $id)
    {
        $user = UserModel::find($id);
        $level = LevelModel::select('level_id', 'level_nama')->get();
        return view('profilemhs.edit_foto', ['user' => $user, 'level' => $level]);
    }
