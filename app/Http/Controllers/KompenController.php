...
class KompenController extends Controller
{
    ...
    public function create_ajax()
    {
        ...
        return view('kompen.create_ajax', ['tipe' => $tipe])
            ->with('jenis', $jenis);
    }
    ...
    public function detail($id)
    {
        ...
        return view('kompen.detail', ['description' => $description, 'activeMenu' => $activeMenu, 'breadcrumb' => $breadcrumb, 'page' => $page]);
    }
    ...
    public function edit_ajax(string $id)
    {
        ...
        return view('kompen.edit_ajax', ['tugas' => $tugas, 'jenis' => $jenis, 'kompetensi' => $kompetensi, 'tipe' => $tipe]);
    }
    ...
    public function confirm_ajax(String $id)
    {
        ...
        return view('kompen.confirm_ajax', ['tugas' => $tugas]);
    }
